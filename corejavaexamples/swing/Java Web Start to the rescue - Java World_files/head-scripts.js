var predates = new Array('03/06/2008','03/07/2008','03/10/2008','03/11/2008','03/12/2008','03/13/2008','03/14/2008');
var topicid;
var subtopicid;
var practive = 0;
var author = "";
...
function CheckPre(URL, cookiename, cookievalue, path, domain) {
	...
	if (showpre == 0) {
	   var q = document.location.search || document.location.href.hash || "";
	   if (q.indexOf("GG_") == -1) {
		   if (outerref == "(none)" && is_ie && document.domain != "dimension.networkworld.com") {		
			  if (doneNewCookie(cookiename) != true) {
			    ...
			    if (doneNewCookie(cookiename) == true) { window.location.href = URL; }
			  }
		   }
	   }
   }
...
CheckPre("/includes/ads-pre.html","pre","done","/","javaworld.com");
function init()
{

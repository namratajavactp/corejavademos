 ...
 */
 class OptionDialogFrame extends JFrame
 {
    public OptionDialogFrame()
    {
      ...
      //icon will change as per message type
    ...
    public Object[] getOptions()
    {
       ...
       if (s.equals("String[]"))
          ...
          return new Icon[]
          {
             ...
             new ImageIcon("z:\\images\\add.gif"),
             new ImageIcon("z:\\images\\code.gif")
          };
       else if (s.equals("Object[]"))
          return new Object[]
          {
    ...
    */
    ...
    private Icon messageIcon = new ImageIcon("z:\\images\\docs.gif");

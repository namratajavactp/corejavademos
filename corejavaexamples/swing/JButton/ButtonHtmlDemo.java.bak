...
public class ButtonHtmlDemo extends JPanel
    ...
    public ButtonHtmlDemo(JFrame j) {
          j.getRootPane().setDefaultButton(b2);
...
//        frame.setVisible(true);
        ...
        b3 = new JButton("<html><center><b><u>E</u>nable</b><br>"
                         + "<font color=#fffddd>middle button</font>", 
                         rightButtonIcon);
        b3.setFont(font);
    ...
    public static void main(String[] args) {
       JFrame.setDefaultLookAndFeelDecorated(true);
        ...
        //Create and set up the content pane.
        ButtonHtmlDemo newContentPane = new ButtonHtmlDemo(frame);
        newContentPane.setOpaque(true); //content panes must be opaque
        frame.setContentPane(newContentPane);

  ...
  */
  class MenuFrame extends JFrame
  {
     public MenuFrame()
     {
       ...
       cutAction.putValue(Action.SMALL_ICON, new ImageIcon("z:\\images\\docs.gif"));
       Action copyAction = new TestAction("Copy");
       copyAction.putValue(Action.SMALL_ICON, new ImageIcon("z:\\images\\execute.gif"));
       Action pasteAction = new TestAction("Paste");
       pasteAction.putValue(Action.SMALL_ICON, new ImageIcon("z:\\images\\code.gif"));

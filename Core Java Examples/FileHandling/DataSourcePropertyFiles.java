...
/* Database connection parameter properties are set */
        tempProp.setProperty("url", "jdbc:oracle:thin:@192.168.12.16:1521:oracle8i");
    ...
    private static Properties alterProperties(Properties p) {
        ...
        while ( enProps.hasMoreElements() ) {
            ...
            /* If we want to alter the username property can be set to new username and also for all the other properties*/        
    ...
    public static void main(String[] args) {
        ...
        final String PROPFILE= "MyProperty.properties";
        Properties myProp;
